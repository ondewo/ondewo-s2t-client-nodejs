...
IMAGE_UTILS_NAME=ondewo-s2t-client-utils-nodejs:${ONDEWO_S2T_VERSION}
PRETTIER_WRITE?=

CURRENT_RELEASE_NOTES=`cat RELEASE.md \
	| perl -ne 'print if /Release ONDEWO S2T Nodejs Client ${ONDEWO_S2T_VERSION}/../^\*{5}/'`

GH_REPO="https://github.com/ondewo/ondewo-s2t-client-nodejs"
...
update_package: ## Updates Package Version in src/package.json
	@perl -i -pe "s/\"version\": \"[0-9]*.[0-9]*.[0-9]\"/\"version\": \"${ONDEWO_S2T_VERSION}\"/g" src/package.json
