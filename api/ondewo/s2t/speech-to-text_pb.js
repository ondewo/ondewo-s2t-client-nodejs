	...
	proto.ondewo.s2t.Transcription.toObject = function (includeInstance, msg) {
		var f,
			obj = {
				...
				wordsList: jspb.Message.toObjectList(msg.getWordsList(), proto.ondewo.s2t.WordDetail.toObject, includeInstance),
...
proto.ondewo.s2t.AcousticModels.prototype.getWav2vec = function () {
	return /** @type{?proto.ondewo.s2t.Wav2Vec} */ (jspb.Message.getWrapperField(this, proto.ondewo.s2t.Wav2Vec, 2));
};
...
proto.ondewo.s2t.AcousticModels.prototype.getWhisper = function () {
	return /** @type{?proto.ondewo.s2t.Whisper} */ (jspb.Message.getWrapperField(this, proto.ondewo.s2t.Whisper, 4));
};
