...
proto.ondewo.s2t.TurnDetectionOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    turnDetectionSystemPrompt: jspb.Message.getFieldWithDefault(msg, 3, ""),
    turnDetectionUserPrompt: jspb.Message.getFieldWithDefault(msg, 4, ""),
...
proto.ondewo.s2t.OpenaiLlmOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    webhookSecret: jspb.Message.getFieldWithDefault(msg, 4, ""),
    baseUrl: jspb.Message.getFieldWithDefault(msg, 5, ""),
    websocketBaseUrl: jspb.Message.getFieldWithDefault(msg, 6, ""),
    ...
    strictResponseValidation: jspb.Message.getBooleanFieldWithDefault(msg, 11, false),
    model: jspb.Message.getFieldWithDefault(msg, 12, ""),
    frequencyPenalty: jspb.Message.getFloatingPointFieldWithDefault(msg, 13, 0.0),
    logitBiasMap: (f = msg.getLogitBiasMap()) ? f.toObject(includeInstance, undefined) : [],
    logprobs: jspb.Message.getBooleanFieldWithDefault(msg, 15, false),
    maxCompletionTokens: jspb.Message.getFieldWithDefault(msg, 16, 0),
    maxTokens: jspb.Message.getFieldWithDefault(msg, 17, 0),
    metadata: (f = msg.getMetadata()) && google_protobuf_struct_pb.Struct.toObject(includeInstance, f),
    n: jspb.Message.getFieldWithDefault(msg, 19, 0),
    presencePenalty: jspb.Message.getFloatingPointFieldWithDefault(msg, 20, 0.0),
    promptCacheKey: jspb.Message.getFieldWithDefault(msg, 21, ""),
    reasoningEffort: jspb.Message.getFieldWithDefault(msg, 22, 0),
    seed: jspb.Message.getFieldWithDefault(msg, 23, 0),
    serviceTier: jspb.Message.getFieldWithDefault(msg, 24, 0),
    stopList: (f = jspb.Message.getRepeatedField(msg, 25)) == null ? undefined : f,
    store: jspb.Message.getBooleanFieldWithDefault(msg, 26, false),
    temperature: jspb.Message.getFloatingPointFieldWithDefault(msg, 27, 0.0),
    topLogprobs: jspb.Message.getFieldWithDefault(msg, 28, 0),
    topP: jspb.Message.getFloatingPointFieldWithDefault(msg, 29, 0.0),
    user: jspb.Message.getFieldWithDefault(msg, 30, ""),
    verbosity: jspb.Message.getFieldWithDefault(msg, 31, 0),
...
proto.ondewo.s2t.S2tLlmPostProcessing.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    s2tLlmPostProcessingSystemPrompt: jspb.Message.getFieldWithDefault(msg, 2, ""),
    s2tLlmPostProcessingEndingPrompt: jspb.Message.getFieldWithDefault(msg, 3, ""),
