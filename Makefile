...
ONDEWO_S2T_VERSION = 4.0.0

S2T_API_GIT_BRANCH=tags/4.0.0
...
CURRENT_RELEASE_NOTES=`cat RELEASE.md \
	| sed -n '/Release ONDEWO S2T Nodejs Client ${ONDEWO_S2T_VERSION}/,/\*\*/p'`
...
check_build: ## Checks if proto-code was generated correctly
